...
Source0  : https://notmuchmail.org/releases/notmuch-0.38.3.tar.xz
Source1  : https://notmuchmail.org/releases/notmuch-0.38.3.tar.xz.asc
...
%prep
%setup -q -n notmuch-0.38.3
cd %{_builddir}/notmuch-0.38.3
%patch -P 1 -p1
pushd ..
cp -a notmuch-0.38.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710169257
