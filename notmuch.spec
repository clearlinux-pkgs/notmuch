...
Source0  : https://notmuchmail.org/releases/notmuch-0.33.1.tar.xz
Source1  : https://notmuchmail.org/releases/notmuch-0.33.1.tar.xz.asc
...
%prep
%setup -q -n notmuch-0.33.1
cd %{_builddir}/notmuch-0.33.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631289234
...
cp %{_builddir}/notmuch-0.33.1/COPYING %{buildroot}/usr/share/package-licenses/notmuch/36e7b160de7f366db25bd7d9f31efd49e8cbe510
cp %{_builddir}/notmuch-0.33.1/COPYING-GPL-3 %{buildroot}/usr/share/package-licenses/notmuch/c5c371a4b28c34d8951a989d53cd28d6035b9662
cp %{_builddir}/notmuch-0.33.1/bindings/python/docs/COPYING %{buildroot}/usr/share/package-licenses/notmuch/0dd432edfab90223f22e49c02e2124f87d6f0a56
cp %{_builddir}/notmuch-0.33.1/contrib/go/LICENSE %{buildroot}/usr/share/package-licenses/notmuch/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/notmuch-0.33.1/debian/copyright %{buildroot}/usr/share/package-licenses/notmuch/cbd7a33d29f170fcd1a8e1d391891574e449c01f
%make_install
