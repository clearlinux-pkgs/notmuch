...
Source0  : https://notmuchmail.org/releases/notmuch-0.31.4.tar.xz
Source1  : https://notmuchmail.org/releases/notmuch-0.31.4.tar.xz.asc
...
%prep
%setup -q -n notmuch-0.31.4
cd %{_builddir}/notmuch-0.31.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613659669
...
cp %{_builddir}/notmuch-0.31.4/COPYING %{buildroot}/usr/share/package-licenses/notmuch/36e7b160de7f366db25bd7d9f31efd49e8cbe510
cp %{_builddir}/notmuch-0.31.4/COPYING-GPL-3 %{buildroot}/usr/share/package-licenses/notmuch/c5c371a4b28c34d8951a989d53cd28d6035b9662
cp %{_builddir}/notmuch-0.31.4/bindings/python/docs/COPYING %{buildroot}/usr/share/package-licenses/notmuch/0dd432edfab90223f22e49c02e2124f87d6f0a56
cp %{_builddir}/notmuch-0.31.4/contrib/go/LICENSE %{buildroot}/usr/share/package-licenses/notmuch/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
